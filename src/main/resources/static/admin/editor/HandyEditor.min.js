...
! function() {
	window.HE = {
		...
		getEditor: function(e, i) {
			...
			var l = this.config.externalSkin;
			return "" != l && ".css" == l.substr(l.length - 4) && this.loadcss(this.config.externalSkin), this.loadScript(d + "/lang/" + this.config.lang + "/" + this.config.lang + ".js", function() {
				for(var n in lang) {
		...
		handyEditor: function(e, i) {
			var n = document.getElementById(e);
			this.define.id = n.id, n.style.display = "none";
			var d = document.createElement("div");
			d.className = "HandyEditor", d.style.width = this.config.width;
			var t = document.createElement("div"),
				o = document.createElement("div");
			o.id = "HandyEditor_menu", o.className = "HandyEditor_menu", o.style.position = "relative", o.style.outline = "none", o.setAttribute("tabindex", 0);
			var a = "";
			for(var l in this.config.item) a += "|" == (f = this.trim(this.config.item[l].toLowerCase())) ? '<span class="HandyEditor_menu_gap"></span>' : '<span class="HandyEditor_menu_item" id="HandyEditor_' + this.define.id + "_" + f + '" style="display: inline-block;" title="' + this.define.lang[f] + '" draggable="true">' + this.define.item[f] + "</span>";
			o.innerHTML = a;
			var r = document.createElement("div");
			r.className = "HandyEditor_editor", r.setAttribute("contenteditable", !0), this.config.autoHeight ? (r.style.minHeight = this.config.height, r.style.height = "auto", r.style.overflowY = "hidden") : (r.style.height = this.config.height, r.style.overflow = "auto"), this.define.obj = r, d.appendChild(t);
			var s = document.createElement("div");
			s.style.zIndex = "9000", this.define.mwobj = s, s.appendChild(o), d.appendChild(s), this.define.mobj = o, d.appendChild(r), this.define.hobj = d, heparent = n.parentNode, heparent.insertBefore(d, n), this.define.obj.innerHTML = n.value, this.define.hetxt = n;
			for(var l in this.config.item) {
				var f;
				"|" != (f = this.trim(this.config.item[l].toLowerCase())) && (document.getElementById("HandyEditor_" + this.define.id + "_" + f).onclick = this[f])
			}
			this.define.obj.onclick = this.editorClick, this.define.mobj.onclick = this.menukongClick, this.config.autoFloat && (window.onscroll = function() {
				...
				HE.define.scrollPos > i && 2 != HE.define.mtop ? (HE.define.mwobj.style.width = "100%", s.style.position = "relative", s.style.top = "0px", t.style.height = "0px", HE.define.mtop = 2) : HE.define.scrollPos > e && HE.define.scrollPos <= i && 1 != HE.define.mtop ? (HE.define.mwobj.style.width = HE.define.hobj.clientWidth + "px", s.style.position = "fixed", s.style.top = HE.config.topOffset + "px", HE.define.mheight = HE.define.mobj.offsetHeight, t.style.height = HE.define.mheight + "px", HE.define.mtop = 1) : HE.define.scrollPos <= e && 0 != HE.define.mtop && (HE.define.mwobj.style.width = "100%", s.style.position = "relative", s.style.top = "0px", t.style.height = "0px", HE.define.mtop = 0)
			}), this.define.obj.onkeydown = function(e) {
				var i = e || window.event;
				if(13 == (i.keyCode || i.which || i.charCode) && HE.handy("formatBlock", "<p>"), i.altKey && i.shiftKey)
					if(document.getElementById("HandyEditor_infodiv")) HE.define.mobj.removeChild(document.getElementById("HandyEditor_infodiv"));
					else {
		...
		loadcss: function(e) {
			...
			i.type = "text/css", i.rel = "stylesheet", i.href = e, document.getElementsByTagName("head")[0].appendChild(i)
		},
		...
		editorClick: function() {
			document.getElementById("HandyEditor_newdiv") && HE.deldiv(), 1 == HE.define.pre && (HE.define.pre = !1), HE.sarea()
		},
		abolish: function() {
		...
		newdiv: function(e) {
			if(HE.define.mobj.blur(), document.getElementById("HandyEditor_newdiv")) HE.deldiv();
				...
				if(n.className = "HandyEditor_newdiv", n.id = "HandyEditor_newdiv", "fontsize" == e)
					...
					var l = HE.getColor();
					t = "<div>" + HE.define.lang.color + ': <input style="border : solid 2px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_color" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_colorok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div><div>" + HE.define.lang.basecolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[0] + "</div><div>" + HE.define.lang.topicolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[1] + "</div>"
				} else if("backcolor" == e) l = HE.getColor(), t = "<div>" + HE.define.lang.backcolor + ': <input style="border : solid 2px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_backcolor" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_backcolorok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div><div>" + HE.define.lang.basecolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[0] + "</div><div>" + HE.define.lang.topicolor + '</div><div class="HandyEditor_newdiv_gap"></div><div>' + l[1] + "</div>";
					...
					if(t = "<div>" + HE.define.lang.imgaddr + ': <input style="border : solid 1px #ddd;padding: 5px;" type="text" id="HandyEditor_newdiv_down_image" /><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_imageok" style="display: inline-block;margin-left: 10px;" draggable="true">' + HE.define.lang.affirm + "</span></div>", 1 == HE.config.uploadPhoto) {
						var r = "",
							s = HE.config.uploadPhotoType.split(",");
						for(var a in s) "" == r ? r = "image/" + HE.trim(s[a]) : r += ",image/" + HE.trim(s[a]);
						t += '<div><input id="HandyEditor_newdiv_down_upload_input" type="file" accept="' + r + '" name="file" style="display:none;"><span class="HandyEditor_menu_item" id="HandyEditor_newdiv_down_upload" style="display: inline-block;margin-left: 10px;">' + HE.define.lang.uploadimage + '</span><span id="HandyEditor_newdiv_down_upload_percent" style="display: inline-block;margin-left: 10px;"></span></div>'
					}
				...
				} else "about" == e && (t = "<div><h3>HandyEditor</h3>" + HE.define.lang.version + "：" + HE.define.version + "<p>" + HE.define.lang.cbefore + '<a href="http://www.catfish-cms.com/" target="_blank">Catfish CMS</a>' + HE.define.lang.cafter + "</p></div>");
				...
				if(i.offsetLeft < n.offsetWidth / 2 && (H = 5), HE.define.mobj.offsetWidth - i.offsetLeft - i.offsetWidth < n.offsetWidth / 2 && (H = HE.define.mobj.offsetWidth - n.offsetWidth - 5), n.style.left = H + "px", n.onclick = function() {
					...
					for(o = 1; o < 8; o++) document.getElementById("HandyEditor_newdiv_down_" + o).onclick = HE.fontsizeEx;
				else if("fontname" == e)
					for(var a in HE.define.font) document.getElementById("HandyEditor_newdiv_down_" + a).onclick = HE.fontnameEx;
				else if("paragraph" == e)
					for(o = 1; o < 8; o++) document.getElementById("HandyEditor_newdiv_down_paragraph_" + o).onclick = HE.paragraphEx;
				else if("color" == e) {
					for(var a in HE.define.color.base) document.getElementById("HandyEditor_newdiv_down_colorblock_base_" + HE.define.color.base[a]).onclick = function() {
					...
					for(var a in HE.define.color.topic)
						for(var o in HE.define.color.topic[a]) document.getElementById("HandyEditor_newdiv_down_colorblock_topic_" + a + "_" + HE.define.color.topic[a][o]).onclick = function() {
							var e = document.getElementById("HandyEditor_newdiv_down_color");
							e.value = "#" + this.title, e.style.borderColor = "#" + this.title
						};
				...
				} else if("link" == e) document.getElementById("HandyEditor_newdiv_down_linkok").onclick = HE.linkokEx;
				else if("code" == e)
					for(var a in HE.define.code) document.getElementById("HandyEditor_newdiv_down_" + a).onclick = HE.codeEx;
				else if("image" == e) {
					...
					for(var a in HE.define.expression) document.getElementById("HandyEditor_newdiv_down_expression_" + a).onclick = HE.expressionEx
			}
		},
		...
		sarea: function(e) {
			var i;
			e = e || !1, window.getSelection ? (i = window.getSelection(), e ? i.removeAllRanges() : HE.define.select = i.getRangeAt(0)) : e ? (document.body.createTextRange().select(), document.selection.empty()) : HE.define.select = document.selection.createRange(), e && (i.addRange(HE.define.select), HE.define.select = null)
		},
		addbr: function() {
		...
		handy: function(e, i) {
			HE.define.obj.focus(), i = i || null, document.execCommand(e, !1, i)
		},
		getText: function() {
			return HE.define.obj.innerText
		},
		getHtml: function() {
			return HE.define.obj.innerHTML
		},
		sync: function() {
			this.define.hetxt.value = HE.define.obj.innerHTML
		},
		bold: function() {
		...
		image: function() {
			HE.define.select || (HE.define.obj.focus(), HE.sarea()), HE.newdiv("image")
		},
		expression: function() {
			HE.define.select || (HE.define.obj.focus(), HE.sarea()), HE.newdiv("expression")
		},
		subscript: function() {
		...
		linkokEx: function() {
			...
			HE.deldiv(), HE.sarea(!0), HE.handy("createLink", e.value)
		},
		imageokEx: function() {
			var e = document.getElementById("HandyEditor_newdiv_down_image");
			HE.deldiv(), HE.sarea(!0), HE.handy("insertImage", e.value)
		},
		uploadFile: function(e) {
			...
			d.open("post", HE.config.uploadPhotoHandler, !0), d.upload.addEventListener("progress", function(e) {
				if(e.lengthComputable) {
					var n = (e.loaded / e.total * 100).toFixed(0);
					i.innerHTML = n + "%"
				}
			}, !1), d.addEventListener("readystatechange", function() {
				var e = d;
				if(4 == e.readyState)
					if(200 == e.status) {
						setTimeout(function() {
						...
						/^(http:\/\/|https:\/\/|\/)?(([\w\-]+\.)*[\w\-]+(\:\d+)?\/)?([\w\-]+\/)*[\w\-]+\.[A-Za-z]{2,4}$/i.test(n) ? document.getElementById("HandyEditor_newdiv_down_image").value = n : alert(e.response)
					} else alert(HE.define.lang.uploadimageerror)
			}), d.send(n)
		},
		colorokEx: function() {
			var e = document.getElementById("HandyEditor_newdiv_down_color").value;
			HE.deldiv(), HE.sarea(!0), HE.handy("foreColor", e)
		},
		backcolorokEx: function() {
			var e = document.getElementById("HandyEditor_newdiv_down_backcolor").value;
			HE.deldiv(), HE.sarea(!0), HE.handy("backColor", e)
		},
		textblock: function() {
		...
		codeEx: function() {
			...
			for(HE.handy("formatBlock", "<pre>"), n = HE.define.obj.getElementsByTagName("pre"), d = 0; d < n.length; d++) HE.hasClass(n[d], "HandyEditor_newdiv_pre_lock") || ("other" == i ? HE.addClass(n[d], "prettyprint") : HE.addClass(n[d], "prettyprint lang-" + i));
		...
		expressionEx: function() {
			...
			HE.deldiv(), HE.sarea(!0), HE.handy("insertImage", e)
		},
		paragraph: function() {
			HE.newdiv("paragraph")
		},
		...
		html: function() {
			if(0 == HE.define.html) {
				...
				i.className = "HandyEditor_newtextarea_textarea", i.style.width = "100%", i.style.height = "100%", i.style.border = "0px", i.style.padding = "10px", i.style.outline = "none", e.appendChild(i), HE.define.hetxt.parentNode.insertBefore(e, HE.define.hetxt), HE.define.taobj = e, HE.define.tarobj = i, HE.define.inh = HE.define.obj.innerHTML, HE.define.inh = HE.define.inh.replace(/\>\</g, ">\n<"), HE.define.tarobj.value = HE.define.inh, HE.define.html = !0, HE.hasClass(this, "HandyEditor_menu_item_valid") || HE.addClass(this, "HandyEditor_menu_item_valid");
				for(var n in HE.config.item) "|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d && ((t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = null, HE.hasClass(t, "HandyEditor_menu_item_invalid") || HE.addClass(t, "HandyEditor_menu_item_invalid"));
				HE.define.tarobj.onclick = function() {
					document.getElementById("HandyEditor_newdiv") && HE.deldiv()
				}
			} else {
				HE.define.inh != HE.define.tarobj.value && (HE.define.obj.innerHTML = HE.define.tarobj.value), HE.define.taobj.parentNode.removeChild(HE.define.taobj), HE.define.html = !1, HE.define.obj.focus(), HE.sarea(!0), HE.hasClass(this, "HandyEditor_menu_item_valid") && HE.removeClass(this, "HandyEditor_menu_item_valid");
				for(var n in HE.config.item) {
					var d, t;
					"|" != (d = HE.trim(HE.config.item[n].toLowerCase())) && "html" != d && "about" != d && ((t = document.getElementById("HandyEditor_" + HE.define.id + "_" + d)).onclick = HE[d], HE.hasClass(t, "HandyEditor_menu_item_invalid") && HE.removeClass(t, "HandyEditor_menu_item_invalid"))
				}
			}
		}
	};
